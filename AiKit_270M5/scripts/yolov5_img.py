...
offset_path = os.path.expanduser('~/convenient_aikit/AiKit_UI/libraries/offset/mechArm 270 for M5_yolov5.txt')
...
class Object_detect():
    ...
    def move(self, x, y, color):
        ...
        time.sleep(0.5)
         ...
         # print(tmp)
        self.mc.send_angles([tmp[0], 17.22, -32.51, tmp[3], 97, tmp[5]],70) # [18.8, -7.91, -54.49, -23.02, -0.79, -14.76]
