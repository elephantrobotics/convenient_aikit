...
class camera_detect:
    ...
    def save_matrix(self, filename="/home/er/convenient_aikit/AiKit_280PI/scripts/EyesInHand_matrix.json"):
        """Save EyesInHand_matrix to JSON file."""
        if self.EyesInHand_matrix is not None:
            with open(filename, 'w') as f:
                json.dump(self.EyesInHand_matrix.tolist(), f)

    def load_matrix(self, filename="/home/er/convenient_aikit/AiKit_280PI/scripts/EyesInHand_matrix.json"):
...
if __name__ == "__main__":
    ...
    camera_params = np.load("/home/er/convenient_aikit/AiKit_280PI/scripts/camera_params.npz")
