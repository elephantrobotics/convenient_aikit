...
offset_path = os.path.expanduser('~/convenient_aikit/AiKit_UI/libraries/offset/myCobot 280 for M5_encode.txt')
...
class Detect_marker():
    ...
    def move(self, x, y, color):
        ...
        # print(tmp)
        self.mc.send_angles([tmp[0], -0.71, -54.49, -23.02, -0.79, tmp[5]], 50) # [18.8, -7.91, -54.49, -23.02, -0.79, -14.76]
