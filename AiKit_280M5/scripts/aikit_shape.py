...
offset_path = os.path.expanduser('~/convenient_aikit/AiKit_UI/libraries/offset/myCobot 280 for M5_shape.txt')

camera_x, camera_y, camera_z = load_offset_from_txt(offset_path)

class Object_detect():

    def __init__(self, camera_x=camera_x, camera_y=camera_y): # 180 10
